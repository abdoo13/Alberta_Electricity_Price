...
dd = st.text('This web application allows predicting electricty prices in the Alberta region for the following sectors: "Residential", "Commercial" and "Industrial".')
st.markdown("<h1 style='text-align: justify;'>dd</h1>", unsafe_allow_html=True)
