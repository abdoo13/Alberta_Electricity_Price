...
if st.sidebar.button("Predict Electricity Prices"):
  ...
  df['Daily GHG Emmisions (Tons_CO2_Equivalent)'] = -0.0003*df['Daily End-Use Demand (GWh)']**2 + 0.4722*df['Daily End-Use Demand (GWh)']
  #
  ...
  for col in list(df_3.columns)[1:]:
    df_3[col] = df[col][0]
